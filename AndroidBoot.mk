...
ifeq ($(IS_RAMDISK_RELOCATION_ENABLED), 1)
	RAMDISK_RELOCATION_ENABLED := RAMDISK_RELOCATION_ENABLED=1
	RAMDISK_LOAD_ADDRESS := RAMDISK_LOAD_ADDRESS=$(RAMDISK_LOAD_ADDRESS)
	RAMDISK_END_ADDRESS := RAMDISK_END_ADDRESS=$(RAMDISK_END_ADDRESS)
else
	RAMDISK_RELOCATION_ENABLED := RAMDISK_RELOCATION_ENABLED=0
	RAMDISK_LOAD_ADDRESS := RAMDISK_LOAD_ADDRESS=0
	RAMDISK_END_ADDRESS := RAMDISK_END_ADDRESS=0
endif
