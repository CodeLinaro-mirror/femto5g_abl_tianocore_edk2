...
ifeq ($(EARLY_ETH_ENABLED_LA), 1)
	EARLY_ETH_ENABLED_LA := 1
else
	EARLY_ETH_ENABLED_LA := 0
endif
...
ABL_FV_IMG: EDK_TOOLS_BIN
	...
	-D HIBERNATION_SUPPORT=$(HIBERNATION_SUPPORT) \
	-D EARLY_ETH_ENABLED=$(EARLY_ETH_ENABLED) \
	-D EARLY_ETH_ENABLED_LA=$(EARLY_ETH_ENABLED_LA) \
