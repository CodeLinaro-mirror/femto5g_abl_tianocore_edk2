...
ifeq ($(BUILD_NATIVE_AARCH64),true)
	...
	export USE_OPENDICE_UDS_DERIVATION := false
...
ifeq ($(USE_OPENDICE_UDS_DERIVATION), true)
	USE_OPENDICE_UDS_DERIVATION := 1
else
	USE_OPENDICE_UDS_DERIVATION := 0
endif
...
ABL_FV_IMG: $(EDK_TOOLS_PATH_MARK_FILE)
	...
	-D USE_OPENDICE_UDS_DERIVATION=$(USE_OPENDICE_UDS_DERIVATION) \
	-D WEAR_OS=$(WEAR_OS) \
